...
namespace APIReact
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string chaineConnection = Configuration.GetConnectionString("APIReactConnection");
            services.AddDbContext<APIReactContext>(options => options.UseSqlServer(chaineConnection));
            ...
            {
                ValidateIssuer = true,
                ValidIssuer = Configuration["JwtSecurityToken:Issuer"], //Configuration.GetSection("JWTSecurity").GetSection("Issuer").value
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info
                {
                    ...
                    TermsOfService = "None",
                    Contact = new Contact { Name = "Anja", Email = "anja.ratsiferana@yahoo.fr" },
